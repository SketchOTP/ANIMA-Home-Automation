...
type Rule = { resource_id: string; mode: Mode; start_local: string; end_local: string; timezone: string; event_kind?: "ANY" | "UNLOCKED" | "LOCKED" | "OPENED" | "CLOSED" | "MOTION" | "DOORBELL" };
