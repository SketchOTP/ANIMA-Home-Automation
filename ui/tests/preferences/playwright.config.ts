...
export default defineConfig({
  testDir: ".", testMatch: "preferences.browser.ts", workers: 1, reporter: "list",
  outputDir: "/tmp/anima-preferences-browser-results",
  use: { baseURL: "http://127.0.0.1:18331", trace: "retain-on-failure" },
  webServer: {
    ...
    url: "http://127.0.0.1:18331", reuseExistingServer: false,
  },
  projects: [
