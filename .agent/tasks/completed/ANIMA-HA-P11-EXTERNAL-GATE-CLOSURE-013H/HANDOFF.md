...
a durable-task fresh external follow-up fixture. The accepted fixed-host,
...
fixture uses a deterministic in-memory store; existing PostgreSQL Phase 10
harness evidence remains the database durability claim.
