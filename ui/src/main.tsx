...
function App() {
  ...
  const descriptions: Record<string, string> = {
    ...
    Settings: "Settings controls how the ANIMA interface looks and which Home widgets appear, plus the active SENTRY projection's voice, speech speed, and sleep mode. These presentation and voice controls do not change household preferences, alert rules, permissions, or device state. Save interface and SENTRY voice settings separately.",
